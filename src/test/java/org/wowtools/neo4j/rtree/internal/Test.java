...
//        //构造测试数据
//        bbox = gf.createPolygon(new Coordinate[]{
...
//
//        }
//        removeNum = (int) (resNum * 0.4);//移除40%的数据
//    }
//
//    private void add() {
...
//        RTree tree = (RTree) SpatialSearches.rTree(b, "test1", mMin, mMax, txCell);
//        resNum -= removeNum;
//        txCell = new TxCell(200, mMin, mMax, new GraphDbTxBuilder(neo4jDbManager.getGraphDb()));
